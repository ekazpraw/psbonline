...
<div class="col-md-10 col-md-offset-1">
    ...
    <div class="col-md-6">
        <label>Alamat:</label>
        <textarea class="form-control" placeholder="Masukkan Alamat Rumah Anda" rows="4" name="alamat" required></textarea>
    </div>
    </div><br>
    <div class="row">
    <div class="col-md-5">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control" name="akte_lahir" placeholder="Masukan Nomor Akte Lahir" required>
    </div>
    </div><br>
    ...
    <div class="col-md-2">
        <label>Dari:</label>
        <input class="form-control" type="text" name="jml_saudara" placeholder="Total Saudara" required/>
    </div>
    <div class="col-md-4">
        <label>Penyakit Yang Pernah Diderita:</label>
        <input class="form-control" type="text" name="penyakit" placeholder="Penyakit yang Pernah Anda Derita" required/>
    </div>
    </div><br>
    ...
    <div class="col-md-3">
        ...
        <input class="form-control" type="text" name="tgl_pindah" id="tgl_pindah" value="-"/>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-12">
        ...
        <input class="form-control" type="text" name="nomor_kk" placeholder="Masukkan Nomor KK Anda" required/>
    </div>
    </div><br>
    ...
    <label>Nama Ayah Kandung:</label>
        <input class="form-control" type="text" name="nama_ayah" placeholder="Sebutkan Nama Ayah" required/>
    </div>
    <div class="col-md-3">
        <label>Nomor NIK Ayah:</label>
        <input class="form-control" type="text" name="nik_ayah" placeholder="Masukkan Nomor NIK Ayah" required/>
    </div>
    <div class="col-md-3">
        <label>Nama Ibu Kandung:</label>
        <input class="form-control" type="text" name="nama_ibu" placeholder="Sebutkan Nama Ibu" required/>
    </div>
    <div class="col-md-3">
        <label>Nomor NIK Ibu:</label>
        <input class="form-control" type="text" name="nik_ibu" placeholder="Masukkan Nomor NIK Ibu" required/>
    </div>
    </div><br>
    ...
    <div class="col-md-3">
        ...
        <input class="form-control" type="text" name="pek_ayah" placeholder="Sebutkan Pekerjaan Ayah" required/>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        ...
        <input class="form-control" type="text" name="pek_ibu" placeholder="Sebutkan Pendidikan Ibu" required/>
    </div>
    </div><br>
    ...
    <label>Jabatan Pekerjaan Ayah:</label>
        <input class="form-control" type="text" name="jab_ayah" placeholder="Tulis Jabatan Kerja Ayah" required/>
    </div>
    <div class="col-md-3">
        <label>Alamat Kantor Ayah:</label>
        <input class="form-control" type="text" name="alkan_ayah" placeholder="Tulis Alamat Kantor Ayah" required/>
    </div>
    <div class="col-md-3">
        <label>Jabatan Pekerjaan Ibu:</label>
        <input class="form-control" type="text" name="jab_ibu" placeholder="Tulis Jabatan Kerja Ibu" required/>
    </div>
    <div class="col-md-3">
        <label>Alamat Kantor Ibu:</label>
        <input class="form-control" type="text" name="alkan_ibu" placeholder="Tulis Alamat Kantor Ibu" required/>
    </div>
    </div><br>
    ...
    <label>Nomor Telepon Ayah:</label>
        <input class="form-control" type="text" name="telp_ayah" placeholder="Sebutkan Nomor Telepon Ayah" required/>
    </div>
    <div class="col-md-6">
        <label>Nomor Telepon Ibu:</label>
        <input class="form-control" type="text" name="telp_ibu" placeholder="Sebutkan Nomor Telepon Ibu" required/>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-md-6">
        ...
        <div class="avatar">
            ...
            <input type="file" name="ak" id="fileToUpload" accept="image/*" required><br>
    </div>
    </div>
    ...
    <div class="avatar">
        ...
        <input type="file" name="ektp" id="fileToUpload" accept="image/*" required><br>
    </div>
    <div class="col-md-6">
        ...
        <div class="avatar">
            ...
            <input type="file" name="skas" id="fileToUpload" accept="image/*" required><br>
    </div>
    </div>  
    </div><br>
