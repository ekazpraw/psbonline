...
<div class="">
  <div class="page-title">
    <div class="title_left">
      <h3>Pendaftar <small>Total Siswa/i Belum Terverifikasi</small></h3>
    </div>
  </div>
        ...
        <div class="x_content">
          <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              $query = mysqli_query($connect, "SELECT * FROM `pendaftar_siswa` WHERE keterangan = 'Belum Terverifikasi'");
              $no = 1;
